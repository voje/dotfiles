...
-- [[ Language-specific plugins and options ]]
-- Comment/uncomment to toggle specific languages

-- require('custom.languages.racket')
-- require('custom.languages.helm')
...
-- Custom ftdetect
-- When editing .yaml files, we want to detect yaml.ansible when we're in 
...
-- Override default yaml and yml ftdetect
vim.filetype.add({
    extension = {
        yaml = maybe_ansible,
        yml = maybe_ansible,
